...
import {
  fg256, bg256, reset, sgr,
  FG, BG, STYLE,
  stripAnsi as stripAnsiFromUtils,
  type ColorLevel,
} from '../utils/ansi.js';
import { hexToRgb, lerpColor, RGB, gradientColor, rgbToHex, type ColorSpace } from '../utils/helpers.js';

export type { ColorLevel };


// v1.6.4 — shared primitives extracted to ./internal
import {
  isNoColor,
  clampRgb, clamp256, safeHex, coerceText, rgbTo256,
  rgbToBasicFg, rgbToBasicBg, adaptiveFg, adaptiveBg,
  wrap,
  type ColorFn,
} from './internal.js';
// Re-export the public suppression/level/cache API unchanged
export {
  setNoColor, resetNoColor, isNoColor, colorLevel, clearColorCache,
} from './internal.js';
export type { ColorFn } from './internal.js';
